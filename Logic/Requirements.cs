...
bool isRequirementMet(Requirement requirment)
{
    switch (requirments)
    {
        case Requirement.Gift_From_Rusl: 
            return checkIfItemIsInList(items::Slingshot,PlacedImportantItems);
            break;
        case Requirement.South_Faron_Cave_Chest: 
            return checkIfItemIsInList(items::Lantern,PlacedImportantItems);
            break;
        case Requirement.Faron_Mist_Cave_Open_Chest: 
            return true;
            break;
        case Requirement.Faron_Mist_Cave_Lantern_Chest: 
            return checkIfItemIsInList(items::Lantern,PlacedImportantItems);
            break;
        case Requirement.North_Faron_Woods_Deku_Baba_Chest: 
            return true;
            break;
        case Requirement.Links_Basement_Chest: 
            return checkIfItemIsInList(items::Lantern,PlacedImportantItems);
            break;
