...
Room[] rooms = {...}; //Place where we manually enter the values of each Room struct excluding the neighbours parameter
...
*Room setupGraph()
{
    ...
    //Lakebed Temple
    rooms[0].neighbours.add(rooms[158]); 
    rooms[0].neighbours.add(rooms[1]);  
